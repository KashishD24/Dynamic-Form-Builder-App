...
export default function TemplateOne({
  ...
  return (
    <>
      <div
        className=" absolute top-0 bg-cover bg-center w-full !h-[15vh]"
        style={{
          backgroundImage: `url(${formBgimage})`,
        }}
      />

      <div className="absolute w-full p-[10px_20px] gap-3 h-[55vh] top-[15vh] overflow-y-scroll hide-scrollbar">
        {fieldsData.map(
          (field: rowData) =>
            field.active &&
      ...
      <div className="absolute bottom-0 w-full h-[60px] flex items-center justify-center p-[10px_20px] bg-gray_600">
        <Button
          type="submit"
          disableRipple
